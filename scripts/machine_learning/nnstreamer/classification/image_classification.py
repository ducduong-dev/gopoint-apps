...
This script launches the Image Classification NNStreamer example using a UI to pick settings.
"""
...
class NNStreamerLauncher:
    ...
    def __init__(self):
        ...
        glade_file = (
            "/root/gopoint-apps/"
            "scripts/machine_learning/nnstreamer/classification/image_classification.glade"
        )
    ...
    def start(self, widget):
        ...
        pipeline = (
            "/root/gopoint-apps/scripts/machine_learning/nnstreamer/classification/example_classification_mobilenet_v1_tflite"
            + cam_op
            + " -b "
            + backend
            + normalization
