...
This script launches the Semantic Segmantation NNStreamer example using a UI to pick settings.
"""
...
class NNStreamerLauncher:
    ...
    def __init__(self):
        ...
        glade_file = (
            "/root/gopoint-apps/"
            "scripts/machine_learning/nnstreamer/semantic_segmentation/semantic_segmentation.glade"
        )
        ...
        # General variables
        self.video_file = "small_dog.jpg"
        self.tflite_model = "deeplabv3_mnv2_dm05_pascal.tflite"
        self.npu_tflite_model = "deeplabv3_mnv2_dm05_pascal_quant_uint8_float32.tflite"
        self.vela_tflite_model = MODELS_PATH + "deeplabv3_mnv2_dm05_pascal_quant_uint8_float32_vela.tflite"
        ...
        devices = []
        self.sources_list.append_text("Example photo")
    ...
    def start(self, widget):
        ...
        pipeline = (
            "/root/gopoint-apps/scripts/machine_learning/nnstreamer/semantic_segmentation/example_segmentation_deeplab_v3_tflite"
            + " -b "
            + backend
            + normalization
            + source
