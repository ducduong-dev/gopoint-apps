...
class NNStreamerLauncher:
    ...
    def __init__(self):
        ...
        glade_file = (
            "/root/gopoint-apps/"
            "scripts/machine_learning/nnstreamer/object_detection/object_detection.glade"
        )
        ...
        if self.platform in ("i.MX95"):
            ...
            self.display_performance.set_sensitive(False)
            self.display_performance.set_active(False)
    ...
    def start(self, widget):
        ...
        pipeline = (
            "/root/gopoint-apps/scripts/machine_learning/nnstreamer/object_detection/example_detection_mobilenet_ssd_v2_tflite"
            + cam_op
            + " -b "
            + backend
            + normalization
