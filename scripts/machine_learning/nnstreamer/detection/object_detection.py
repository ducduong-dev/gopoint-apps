...
class NNStreamerLauncher:
    ...
    def __init__(self):
        ...
        glade_file = (
            "/root/gopoint-apps/"
            "scripts/machine_learning/nnstreamer/detection/object_detection.glade"
        )
    ...
    def start(self, widget):
        ...
        pipeline = (
            "/root/gopoint-apps/scripts/machine_learning/nnstreamer/detection/example_detection_mobilenet_ssd_v2_tflite"
            " -c "
            + device
            + " -b "
            + backend
