...
class DialogWindow(Gtk.Window):
    def __init__(self):
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_scale(
            filename="/root/gopoint-apps/scripts/TSN/qbv/TSN_Qbv_setup_diagram.png",
            width=900,
            height=520,
        ...
        if (
            ...
            if ssh_connection == 0:
                ...
                image = Gtk.Image()
                image.set_from_file(
                    "/root/gopoint-apps/scripts/TSN/qbv/TSN_Qbv_setup_diagram.png"
                )
                ...
                dialog.run()
                os.system(
                    "python3 /root/gopoint-apps/scripts/TSN/qbv/tsnqbv.py stop root 192.168.0.1"
                )
                dialog.destroy()
    ...
    def on_start(self):
        if list1[0] == "Pass" and list1[1] == "Pass":
            os.system(
                "python3 /root/gopoint-apps/scripts/TSN/qbv/loading_window.py run_demo &"
            )
            os.system(
                "python3 /root/gopoint-apps/scripts/TSN/qbv/tsnqbv.py start root 192.168.0.1 &"
            )
    ...
    def on_video_combo_changed(self, combo):
        ...
        print(text)
        y = open("/root/gopoint-apps/scripts/TSN/qbv/video.txt", "w")
        y.write(text)
        y.close()
        list1[0] = "Pass"
        list1[1] = "Pass"
